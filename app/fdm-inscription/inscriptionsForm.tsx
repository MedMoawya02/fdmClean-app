...
// ─── Composant principal ──────────────────────────────────────
export default function InscriptionForm({ initialType }: { initialType: "agent" | "client" }) {
  const [type, setType] = useState<"agent" | "client">(initialType);
  ...
  return (
    <div className={styles.page}>
      {/* ─── PANEL GAUCHE (statique, dépend du type) ─── */}
      ...
      {/* ─── PANEL DROIT (formulaire ou succès) ─── */}
