  ...
  return (
    <>
          ...
          <div className="nav-inner">
            ...
            <div className="nav-links">
              ...
              <Link href="/particuliers"
                className={`nav-link ${isActive("/particuliers") ? "active" : ""}`}>
                Particuliers
              </Link>

              <Link href="/annuaire"
                className={`nav-link ${isActive("/annuaire") ? "active" : ""}`}>
                Annuaire
              </Link>
            ...
            <div className="nav-right">
              ...
              <Link href="/particuliers" className="nav-cta">
                Réserver →
              </Link>
      ...
      <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        ...
        <Link href="/qui-sommes-nous">ℹ️ Qui sommes-nous</Link>
